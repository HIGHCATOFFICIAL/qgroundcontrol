    ...
    Component {
        ...
        ColumnLayout {
            ...
            SettingsGroupLayout {
                ...
                showDividers:   false
                visible:        _gimbalControllerSettings.joystickGimbalShowUI.rawValue
            ...
            SettingsGroupLayout {
                ...
                showDividers:   false
                visible:        _gimbalControllerSettings.joystickGimbalShowUI.rawValue && enableJoystickGimbalCheckbox.checked

                RowLayout {
                    Layout.fillWidth: true

                    QGCLabel {
                        text: qsTr("Recent gimbal commands:")
                    }
                    ...
                    QGCButton {
                        text: qsTr("Clear")
                        onClicked: gimbalController.clearMessageLog()
                    }
                }
                ...
                Rectangle {
                    ...
                    QGCFlickable {
                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                model: gimbalController.gimbalMessageLog
                            ...
                            QGCLabel {
                                visible:            gimbalController.gimbalMessageLog.length === 0
